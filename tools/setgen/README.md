...
graph handles holding the files only that event leads to, weapon sets keyed on the equip
...
From the 49 actor projects, about 100 seconds:

    projects   49
    sets       2470  (95532 animations listed, 3819 attacks)
...
| of the rest: first-person killmoves appended later, and the werewolf's human-side killmoves | 66 + 5 |
| files of a shipped idle set that its own keys load | 2,020 of 2,689 (75.1%) |
| attack entries identical, over the 121 weapon combinations a race asks about | 21,797 of 27,039 (80.6%) |
| one-set creatures identical to the shipped set | 26 of 38 |
| size | 3.6 MB (shipped 0.8 MB) |

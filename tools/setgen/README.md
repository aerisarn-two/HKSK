...
graph handles holding every file that event can lead to before the graph is home again, weapon sets keyed on the equip
...
From the 49 actor projects, about 30 seconds:

    projects   49
    sets       1883  (67034 animations listed, 3819 attacks)

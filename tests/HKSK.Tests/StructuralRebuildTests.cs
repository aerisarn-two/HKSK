...
public sealed class StructuralRebuildTests
{
    ...
    /// motion under them, <strong>573 of their 703 curves are within 2% at every
    /// point</strong>.
    /// </para>
    /// <para>
    ...
    public void TheGraphAloneRebuildsTheCurvesItCanReach()
    {
        ...
        Assert.Equal(573, done.Sum(r => r.Held));
    ...
    /// it. Without the daedra, 573 of 684 hold here.
    /// </remarks>
    [CorpusFact]
    public void WithoutTheKnownHalvingFourInFiveCurvesHold()
    {
        ...
        Assert.Equal(573, rest.Sum(r => r.Held));
    }
